...
def initialize(algo, merda, eps=1, window_length=5):
    algo.stocks = STOCKS
...
if __name__ == '__main__':
    ...
    data = data.dropna()
    data['MMM'].loc['20040108':'20040109'] = np.NaN
    
    
    print data.loc['20040107':'20040110']
    merda = ['jaulino']
    # Create and run the algorithm.
    olmar = TradingAlgorithm(handle_data=handle_data,
                             initialize=initialize,
                             identifiers=STOCKS, merda = merda)
